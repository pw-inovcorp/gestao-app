    ...
    <div class="space-y-6">
        <Card>
            ...
            <CardContent class="space-y-6">
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    <FormField v-slot="{ componentField }" name="validade">
                        <FormItem>
                            <FormLabel>Data de Validade *</FormLabel>
                            <FormControl>
                                <Input type="date" v-bind="componentField" />
                            </FormControl>
                            <FormDescription>Padrão: 30 dias a partir de hoje</FormDescription>
                            <FormMessage />
                        </FormItem>
                    </FormField>
                    ...
                    <FormField v-slot="{ componentField }" name="estado">
                        <FormItem>
                            ...
                            <FormDescription>Ao fechar, a data da proposta será definida automaticamente</FormDescription>
                            <FormMessage />
                        </FormItem>
                    </FormField>
                </div>
        ...
        <Card>
            <CardHeader>
                ...
                <CardDescription>Pesquisar e adicionar artigos à proposta</CardDescription>
            </CardHeader>
