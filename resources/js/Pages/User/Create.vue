    ...
    <AppLayout>
        <div class="max-w-4xl mx-auto space-y-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold">Novo Utilizador</h1>
                    <p class="text-slate-600 mt-1">Criar novo utilizador do sistema</p>
                </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Preencha os dados do novo utilizador</CardDescription>
                </CardHeader>
                <CardContent>
                    <form @submit="onSubmit" class="space-y-6">
                        ...
                        <div class="flex gap-4 pt-4">
                            <Button type="submit" :disabled="inertiaForm.processing" class="flex-1">
                                ...
                                <span v-else>Criar Utilizador</span>
                            </Button>
